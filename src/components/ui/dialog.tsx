  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed inset-0 m-auto z-50 grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg h-fit max-h-[calc(100vh-2rem)]",
          className
        )}
        aria-describedby={ariaDescribedBy ?? (fallbackDescription ? descriptionId : undefined)}
        {...rest}
      >
        {!ariaDescribedBy && fallbackDescription && (
